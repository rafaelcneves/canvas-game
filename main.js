...
var hud_1 = __webpack_require__(5);
var Main = (function () {
    function Main() {
        this.keyMap = {};
        this.state = 0;
        ...
        this.hud = new hud_1.Hud(this.context);
    }
    ...
    Main.prototype.mainloop = function () {
        ...
        this.bricks.forEach(function (brick, i) {
            if (brick.detectColisionBrickxBall(_this.ball)) {
                ...
                _this.hud.scoreIncrement();
                if (_this.bricks.length == 0) {
                    _this.state = 3;
                    _this.hud.updateHiscore();
                }
            }
        });
        this.paint();
...
var Raquete = (function () {
    ...
    Raquete.prototype.detectColisionPlayerxBall = function (ball) {
...
var Bola = (function () {
    ...
    Bola.prototype.detectWallColision = function () {
    ...
    Bola.prototype.detectOutOfBounds = function () {
...
var Hud = (function () {
    ...
    Hud.prototype.paint = function (state) {
    ...
    Hud.prototype.scoreIncrement = function () {
        this.score++;
    };
    Hud.prototype.scoreReset = function () {
        this.score = 0;
    };
    Hud.prototype.updateHiscore = function () {
